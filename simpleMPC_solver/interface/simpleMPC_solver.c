...
{
	/* Some memory */
	static internal_simpleMPC_solver_1_params params_1;
	static internal_simpleMPC_solver_1_output output_1;
	static internal_simpleMPC_solver_1_info info_1;
	...
	/*Assigning parameter values of solver #1*/
	params_1.p_1[0] = -25.000000000000000000;
	params_1.p_1[0] += (1.000000000000000000 * params->xinit[0]);
	params_1.p_1[1] = 42.000000000000000000;
	params_1.p_1[1] += (1.000000000000000000 * params->xinit[1]);
	params_1.p_1[2] = 18.500000000000000000;
	params_1.p_1[2] += (1.000000000000000000 * params->xinit[2]);
	...
	/* OUTPUTS -----------------------------------------------------------*/
	/*Build outputs*/
	output->u0[0] = (1.000000000000000000 * output_1.o_1[0]);

	output->u0[1] = (1.000000000000000000 * output_1.o_2[0]);

	output->u0[2] = (1.000000000000000000 * output_1.o_3[0]);
